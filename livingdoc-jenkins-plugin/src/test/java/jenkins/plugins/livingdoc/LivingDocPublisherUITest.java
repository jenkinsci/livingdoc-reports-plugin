...
public class LivingDocPublisherUITest extends JenkinsUITestCase {
    ...
    public void testVerifyStateForNewProject () throws Exception {
    ...
    public void testCheckParametersPersistence () throws Exception {
