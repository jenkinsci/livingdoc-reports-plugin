...
public class LivingDocProjectActionTest {
    ...
    public void shouldRedirectToFirstBuildFound () {
         ...
         * when(build.getAction(LivingDocBuildAction.class)).thenReturn(new
         * LivingDocBuildAction(null, null));
         * 
         ...
         * verify(response).sendRedirect2("../999/livingdoc"); */
    }
    ...
    public void shouldRedirectToFirstBuildFoundWhenMultipleBuilds () {
         ...
         * when(build2.getAction(LivingDocBuildAction.class)).thenReturn(new
         * LivingDocBuildAction(null, null));
         * 
