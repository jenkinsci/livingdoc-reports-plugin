...
public class PostExecutionResultPublisherTest {
	...
	private static File report = new File(
...
//		System.setProperty("javax.net.ssl.trustStore", "e:/dev/keystores/daimler.git.jks");
...
//		System.setProperty("java.net.preferIPv4Stack", "true");
	...
	public void testPublish() throws Exception {
		String url = "https://s415vmmt060.detss.corpintra.net/confluence/rpc/xmlrpc?handler=livingdoc1&sut=XP-DEV0&includeStyle=true&implemented=true#XLD";
	...
	String loadRepoprt() throws IOException {
