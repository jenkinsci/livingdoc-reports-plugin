...
import jenkins.plugins.livingdoc.LivingDocPublisherConfig;
import jenkins.plugins.livingdoc.LivingDocReportCollector;
...
public class LivingDocReportCollectorTest {
	...
	public static void initBaseDir() throws Exception {
		...
		URL dirUrl = LivingDocReportCollectorTest.class
				.getResource("LivingDocReportCollector");
	...
	public void getLocation() throws IOException, InterruptedException {
		String[][] values = new String[][] {
				{
						...
						"prefix-", "Confluence Site Title", "KEY",
						"Confluence Site Title-KEY/LL - My Executable Spec" },
				{ "prefix-LL - My Executable Spec.html", "prefix-",
						"Confluence Site Title", "KEY",
						"Confluence Site Title-KEY/LL - My Executable Spec" },
				{ "prefix-LL - My Executable Spec.html.xml", "prefix-",
						"Confluence Site Title", "KEY",
						"Confluence Site Title-KEY/LL - My Executable Spec" },
				{ "prefix-LL - My Executable Spec.htm", "prefix-",
						"Confluence Site Title", "KEY",
						"Confluence Site Title-KEY/LL - My Executable Spec" },
				{ "prefix-LL - My Executable Spec.xml", "prefix-",
						"Confluence Site Title", "KEY",
						"Confluence Site Title-KEY/LL - My Executable Spec" },
		...
		FilePath path = new FilePath(File.createTempFile("temp", "temp")
				.getParentFile());
		for (int i = 0; i < values.length; i++) {
			...
			LivingDocReportCollector collector = new LivingDocReportCollector(
					path, i, config, null);
	...
	private LivingDocReportCollector newReportCollector(
			String testResultsPattern) throws Exception {
		LivingDocPublisherConfig config = new LivingDocPublisherConfig();
		config.setTestResultsPattern(testResultsPattern);
		return new LivingDocReportCollector(buildDir, 1, config, null);
	}
}