...
public class PostExecutionResultPublisher {
    ...
    public void specificationDone () throws Exception {
        ...
        Vector<Serializable> args =
            CollectionUtil.toVector(args1[1], args1[2], CollectionUtil.toVector(location.getFragment(),
                definitionRef.get(4), sut, xmlReport));
    ...
    private void init (String url, String location) throws Exception {
         ...
         * https://s415vmmt060
         * .detss.corpintra.net/confluence/rpc/xmlrpc?handler=greenpepper1#XLD,
         * greenpepper, 5c23h8kt, ST - TV - Kundenwunsch E4-E6]
         */
    ...
    private String[] args (Vector<String> definition) {
        ...
        args[0] = definition.get(1);// includeStyle ? definition.get(1) :
                                    // withNoStyle(definition.get(1));
