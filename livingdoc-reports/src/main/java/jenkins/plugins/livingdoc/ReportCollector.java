...
public class ReportCollector implements FilePath.FileCallable<SummaryBuildReportBean> {
    ...
    private static final Logger LOGGER = Logger.getLogger(ReportCollector.class.getCanonicalName());
    ...
    public ReportCollector(FilePath buildDir, int buildId, String testResultsPattern) throws IOException,
